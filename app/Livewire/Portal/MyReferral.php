...
class MyReferral extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.portal.my-referral', [
            ...
            'level_1_purchase_total' => $level1Total,
            'level_2_purchase_total' => $level2Total,
            'level_3_purchase_total' => $level3Total,
            'level_4_purchase_total' => $level4Total,
            'level_5_purchase_total' => $level5Total,
            'level_6_purchase_total' => $level6Total,
            'level_7_purchase_total' => $level7Total,

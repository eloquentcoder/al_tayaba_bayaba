<div>
    ...
    <section class="login-section register-section">
        <div class="container">
            <div class="row">
                <div class="col">
                        <p id="referrer" class="text-gray-700 text-lg golden-text"></p>
                    <div class="login-box">
                        <form wire:submit="doRegister">
                            <input type="hidden" name="_token" value="eyMmaUdfwFpo2o10Xuplh41oWJ6ToUfyF0KBr3Mo">

                            <input type="hidden" wire:model="referrer" id="hiddenReferrer">
                                    ...
                                    <div class="box mb-4">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="input-group">
                                                <div class="img">
                                                    <img src="{{ asset('themes/deepblack/img/icon/edit.png') }}"
                                                        alt="first name img" />
                                                </div>
                                ...
                                <div class="col-md-12 phonenumber">
                                    <div class="form-group mb-30">
                                        ...
                                        <div class="box mb-4">
                                            ...
                                            <div class="input-group flex gap-6">
                                                <div class="input-group-prepend w-50">
                                                    <select wire:model="phone_code"
                                                        ...
                                                        <option value="+226" data-name="Burkina Faso"
                                                            data-code="BF"> Burkina Faso (+226)
                                                        </option>
                                                        <option value="+95" data-name="Burma Myanmar"
                                                            data-code="MM"> Burma Myanmar (+95)
                                                        </option>
                                                        ...
                                                        <option value="+420" data-name="Czech Republic"
                                                            data-code="CZ"> Czech Republic (+420)
                                                        </option>
                                                        ...
                                                        <option value="+298" data-name="Faroe Islands"
                                                            data-code="FO"> Faroe Islands (+298)
                                                        </option>
                                                        ...
                                                        <option value="+594" data-name="French Guiana"
                                                            data-code="GF"> French Guiana (+594)
                                                        </option>
                                                        ...
                                                        <option value="+245" data-name="Guinea-Bissau"
                                                            data-code="GW"> Guinea-Bissau (+245)
                                                        </option>
                                                        ...
                                                        <option value="+423" data-name="Liechtenstein"
                                                            data-code="LI"> Liechtenstein (+423)
                                                        </option>
                                                        ...
                                                        <option value="+687" data-name="New Caledonia"
                                                            data-code="NC"> New Caledonia (+687)
                                                        </option>
                                                        <option value="+64" data-name="New Zealand"
                                                            data-code="NZ"> New Zealand (+64)
                                                        </option>
...
<script>
        ...
        // Display the ref value inside the p tag
        if (ref) {
            document.getElementById('referrer').innerText = `Referral By: ${ref}`;
            document.getElementById('hiddenReferrer').value = ref;
        } else {
            document.getElementById('referrer').innerText = 'Referral By: Admin';
        }
    </script>
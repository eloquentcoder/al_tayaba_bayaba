              ...
              <div class="col">
                 <div class="login-box">
                    <form wire:submit="doRegister">
                        <input type="hidden" name="_token" value="eyMmaUdfwFpo2o10Xuplh41oWJ6ToUfyF0KBr3Mo">                        <div class="row">
                                ...
                                <div class="box mb-4">
                                    ...
                                    <div class="flex flex-col">
                                        <div class="input-group">
                                            <div class="img">
                                                <img src="{{ asset('themes/deepblack/img/icon/edit.png')}}" alt="first name img" />
                                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="box mb-4">
                                    ...
                                    <div class="flex flex-col">
                                        <div class="input-group">
                                            <div class="img">
                                                <img src="{{ asset('themes/deepblack/img/icon/edit.png')}}" alt="lastname img" />
                                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="box mb-4">
                                    ...
                                    <div class="flex flex-col">
                                        <div class="input-group">
                                            <div class="img">
                                                <img src="{{ asset('themes/deepblack/img/icon/edit.png')}}" alt="username img" />
                                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="box mb-4">
                                   ...
                                   <div class="flex flex-col">
                                    <div class="input-group">
                                        <div class="img">
                                            <img src="{{ asset('themes/deepblack/img/icon/email2.png')}}" alt="email img" />
                                        </div>
                                    ...
                                    <div class="box mb-4">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend w-50">
                                                <select wire:model="phone_code" class="form-control country_code dialCode-change">
                                                                            <option value="+93"

<div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-white">
    <div class="flex justify-between items-center">
        <h2 class="text-3xl font-bold text-white mb-6">Users</h2>
    </div>
    ...
    <div class="mt-10">
        ...
        <input type="text" wire:model.live="search" class="form-control my-2 p-2 rounded-md text-black" placeholder="Search Users..." />
                    ...
                    @foreach ($users as $key => $user)
                        <tr>
                            ...
                            <td class="py-3 px-4 text-black flex items-center gap-2">
                                ...
                                <div wire:click="toggleBlockUser({{ $user }})">
                                    @if ($user->is_active)
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-4 cursor-pointer">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <svg wire:click="deleteUser({{ $user }})" xmlns="http://www.w3.org/2000/svg"

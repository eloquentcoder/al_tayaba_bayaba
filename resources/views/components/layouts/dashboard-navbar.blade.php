<header class="flex justify-end items-center mb-8 bg-[#ffffff] p-6 relative">
    <div class="flex items-center space-x-4">
        ...
        <div class="relative">
            <img id="profileDropdownButton" class="w-8 h-8 rounded-full border-2 border-[#0f277e] cursor-pointer" src={{ asset('person-icon.png')}} alt="User Profile">
            <!-- Dropdown Menu -->
            <div id="profileDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg z-20">
                <a href="{{ route('portal.dashboard') }}" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Dashboard</a>
                <a href="{{ route('portal.profile') }}" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">My Profile</a>
                <a href="{{ route('portal.twostep-security') }}" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">2FA Security</a>

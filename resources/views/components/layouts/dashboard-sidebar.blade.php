<aside class="w-64 bg-[#ffffff] space-y-6 overflow-auto h-screen">
        ...
        <div>
            ...
            <div class="space-y-1">
              ...
              <div class="mt-5 w-full flex gap-2">
                ...
                <a href="{{ route('portal.payout') }}" class="rounded-full text-white bg-[#0f277e] p-2 w-full flex justify-center items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
    ...
    <nav class="">
        ...
        <a href="{{ route('portal.deposit-history') }}" class="flex items-center p-5 rounded hover:bg-gray-100 hover:text-white border-b border-b-black">
        ...
        <a href="{{ route('portal.referrals') }}" class="flex items-center p-5 rounded hover:bg-gray-100 hover:text-white border-b border-b-black">

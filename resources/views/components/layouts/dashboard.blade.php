...
<body class="background bg-cover bg-no-repeat text-white font-sans">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside class="w-64 bg-[#222222] space-y-6 overflow-auto">
            ...
            <nav class="">
                <a href="#" class="bg-black flex items-center text-[#af8a3e] font-semibold p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke="url(#grad1)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-no-axes-combined ">
                        <defs>
                            <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                              <stop offset="0%" style="stop-color:#af8a3e;stop-opacity:1" />
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Trading partner</span>
                </a>
                <a href="#" class="bg-black flex items-center text-[#af8a3e] font-semibold p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Dashboard</span>
                </a>
                <a href="#" class="bg-black flex items-center text-[#af8a3e] font-semibold p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Badges</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Packages</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Invest history</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">deposit history</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="url(#grad1)" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-receipt"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">withdraw history</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">transfer</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">my referral</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">referral bonus</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">transactions</span>
                </a>
                <a href="#" class="flex items-center p-5 rounded hover:bg-gray-700 border-b border-b-black">
                    ...
                    <span class="uppercase ml-2 bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">support ticket</span>
                </a>
          ...
          rgba(0, 0, 0, 0.7)
            ...
            <header class="flex justify-end items-center mb-8 bg-[#222222] p-6">
                <div class="flex items-center space-x-4">
                    <div class="relative">
                        <span class="material-icons text-[#af8a3e]">notifications</span>
                        <span class="absolute top-0 right-0 bg-[#af8a3e] text-xs text-black font-bold rounded-full px-1">3227</span>
                    </div>
                    <img class="w-8 h-8 rounded-full border-2 border-[#af8a3e]" src="https://via.placeholder.com/50" alt="User Profile">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-[#af8a3e]">
                ...
                <div class="bg-[#222222] p-4 rounded-lg shadow-lg text-center text-white">
                    ...
                    <div class="flex items-center justify-center mb-4">
                        <div class="bg-gray-900 hexagon w-12 h-12 flex items-center justify-center rounded-full">
                            ...
                            <svg class="w-6 h-6 text-[#af8a3e]" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 0l10.392 6v12l-10.392 6-10.392-6v-12z"/>
                            </svg>
                        </div>
                    </div>
                    <!-- Card Title -->
                    <p class="text-sm font-semibold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Total Deposit</p>
                    <!-- Card Value with Gradient -->
                    <p class="text-3xl font-bold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">$25,000.0</p>
                </div>
                <div class="bg-[#222222] p-4 rounded-lg shadow-lg text-center text-white">
                    <!-- Hexagon Icon Background -->
                    <div class="flex items-center justify-center mb-4">
                    ...
                    <!-- Card Title -->
                    <p class="text-sm font-semibold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Total Invest</p>
                    <!-- Card Value with Gradient -->
                    <p class="text-3xl font-bold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">$25,000.0</p>
                </div>
                <div class="bg-[#222222] p-4 rounded-lg shadow-lg text-center text-white">
                    ...
                    <!-- Card Title -->
                    <p class="text-sm font-semibold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Total Earn</p>
                    <!-- Card Value with Gradient -->
                    <p class="text-3xl font-bold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">$43,100.0</p>
                </div>
                <div class="bg-[#222222] p-4 rounded-lg shadow-lg text-center text-white">
                    <!-- Hexagon Icon Background -->
                    <div class="flex items-center justify-center mb-4">
                    ...
                    <!-- Card Title -->
                    <p class="text-sm font-semibold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Total Withdraw</p>
                    <!-- Card Value with Gradient -->
                    <p class="text-3xl font-bold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">$8,000.0</p>
                </div>
                <div class="bg-[#222222] p-4 rounded-lg shadow-lg text-center text-white">
                    <!-- Hexagon Icon Background -->
                    <div class="flex items-center justify-center mb-4">
                    ...
                    <!-- Card Title -->
                    <p class="text-sm font-semibold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Total Tickets</p>
                    <!-- Card Value with Gradient -->
                    <p class="text-3xl font-bold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">0</p>
                </div>
                <div class="bg-[#222222] p-4 rounded-lg shadow-lg text-center text-white">
                    <!-- Hexagon Icon Background -->
                    <div class="flex items-center justify-center mb-4">
                    ...
                    <!-- Card Title -->
                    <p class="text-sm font-semibold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Total Referral Bonus</p>
                    <!-- Card Value with Gradient -->
                    <p class="text-3xl font-bold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">$25,000.0</p>
                </div>
                <div class="bg-[#222222] p-4 rounded-lg shadow-lg text-center text-white">
                    ...
                    <!-- Card Title -->
                    <p class="text-sm font-semibold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Total Team Sales</p>
                    <!-- Card Value with Gradient -->
                    <p class="text-3xl font-bold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">$2800.0</p>
                </div>
                <div class="bg-[#222222] p-4 rounded-lg shadow-lg text-center text-white">
                    <!-- Hexagon Icon Background -->
                    <div class="flex items-center justify-center mb-4">
                    ...
                    <!-- Card Title -->
                    <p class="text-sm font-semibold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">Total Group Sales</p>
                    <!-- Card Value with Gradient -->
                    <p class="text-3xl font-bold bg-gradient-to-r from-white to-[#af8a3e] text-transparent bg-clip-text">$115,466</p>
                </div>
            </div>

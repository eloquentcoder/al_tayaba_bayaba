    ...
    <nav>
        ...
        @if (auth()->user()->admin->is_super_admin)
            <a href="{{ route('admin.admins') }}"
                class="{{ request()->routeIs('admin.admins') ? 'bg-[#0f277e] text-[#ffffff]' : 'text-[#0f277e]' }} flex items-center text-[#0f277e] p-5 rounded hover:bg-gray-100 hover:text-white border-b border-b-black">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="url(#grad1)" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        @if (auth()->user()->admin->is_super_admin)
            <a href="{{ route('admin.plans') }}"
                class="{{ request()->routeIs('admin.plans') ? 'bg-[#0f277e] text-[#ffffff]' : 'text-[#0f277e]' }} flex items-center text-[#0f277e] p-5 rounded hover:bg-gray-100 hover:text-white border-b border-b-black">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="url(#grad1)" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="lucide lucide-file-badge-2">
                    <defs>
        ...
        <a href="{{ route('admin.subscription-requests') }}"
            class="{{ request()->routeIs('admin.subscription-requests') ? 'bg-[#0f277e] text-[#ffffff]' : 'text-[#0f277e]' }} flex items-center text-[#0f277e] p-5 rounded hover:bg-gray-100 hover:text-white border-b border-b-black">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="url(#grad1)" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="lucide lucide-file-badge-2">
                <defs>
            ...
            <span
                class="uppercase ml-2 {{ request()->routeIs('admin.subscription-requests') ? 'text-[#ffffff]' : 'text-[#0f277e]' }}">Subscription
                Requests</span>
        </a>
        <a href="{{ route('admin.withdrawal-requests') }}"
            class="{{ request()->routeIs('admin.withdrawal-requests') ? 'bg-[#0f277e] text-[#ffffff]' : 'text-[#0f277e]' }} flex items-center text-[#0f277e] p-5 rounded hover:bg-gray-100 hover:text-white border-b border-b-black">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="url(#grad1)" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="lucide lucide-file-badge-2">
                <defs>
            ...
            <span
                class="uppercase ml-2 {{ request()->routeIs('admin.withdrawal-requests') ? 'text-[#ffffff]' : 'text-[#0f277e]' }}">Withdrawal Requests
                History</span>
        </a>
        <a href="{{ route('admin.transactions') }}"
            class="{{ request()->routeIs('admin.transactions') ? 'bg-[#0f277e] text-[#ffffff]' : 'text-[#0f277e]' }} flex items-center text-[#0f277e] p-5 rounded hover:bg-gray-100 hover:text-white border-b border-b-black">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="url(#grad1)" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="lucide lucide-file-badge-2">
                <defs>
            ...
            <span
                class="uppercase ml-2 {{ request()->routeIs('admin.transactions') ? 'text-[#ffffff]' : 'text-[#0f277e]' }}">Transaction
                History</span>
        </a>
        <a href="{{ route('admin.contact-forms') }}"
            class="{{ request()->routeIs('admin.contact-forms') ? 'bg-[#0f277e] text-[#ffffff]' : 'text-[#0f277e]' }} flex items-center text-[#0f277e] p-5 rounded hover:bg-gray-100 hover:text-white border-b border-b-black">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="url(#grad1)" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="lucide lucide-file-badge-2">
                <defs>
            ...
            <span
                class="uppercase ml-2 {{ request()->routeIs('admin.contact-forms') ? 'text-[#ffffff]' : 'text-[#0f277e]' }}">Contact
                Forms
                Requests</span>
        </a>
